        ...
        <div class="block1">
          ...
          if ($login == $_COOKIE['user']):
            ...
            <div class="profileButtons">
              <button class="button" onclick="self.location = '#settings';"><i class="fa-solid fa-gear"></i>
                Налаштування</button>
              <button class="button" onclick="self.location = '/validatoin-form/exit.php';"><i
            ...
            if (empty($postInfo)) {
              if ($login == $_COOKIE['user']) { ?>
                <div class="postClear">
                  ...
                  <button class="button postClearButt" onclick="self.location = 'content.php';">Створити публікацію</button>
                </div>
              <?php } else {
      ...
      if ($login == $_COOKIE['user']):
        ...
        <div class="windBack" id="settings"> <!--Изменение профиля-->
          <div class="wind">
            ...
            <textarea name="description" placeholder="Введіть новий опис" class="pole4 windEditDescription" maxlength="5000"
              required><?= $pageInfo['description'] ?></textarea>
            <div class="profileLine">
              <hr color="#414141">
              <p class="hrText">
              ...
              foreach ($profileLinkInfo as $profileLink):
                ...
                <details id="<?= $profileLink['id'] ?>">
                  ...
                  <div class="windLinksInput">
                    ...
                    <input type="text" name="linkName-<?= $profileLink['id'] ?>" placeholder="Введіть назву посилання" class="pole1 inputLink"
                      value="<?= $profileLink['link_name'] ?>" maxlength="250" required>
                    <input type="url" name="url-<?= $profileLink['id'] ?>" placeholder="Вставте посилання" class="pole1 inputLink"
                      value="<?= $profileLink['link_url'] ?>" maxlength="250" required>
                  </div>
                  <hr color="#414141">
                </details>
              <?php endforeach; ?>
              ...
              <details id="link">
                ...
                <div class="windLinksInput">
                  <input type="text" name="linkNameNew" placeholder="Введіть назву посилання" class="pole1 inputLink"
                    maxlength="250">
                  <input type="url" name="linkUrlNew" placeholder="Вставте посилання" class="pole1 inputLink" maxlength="250">
                </div>
                <hr color="#414141">
              </details>
          ...
          <div class="windSafety">
            <p>Для убезпечення вашого аккаунту рекомендовано ввести електронну пошту. В разі чого, за допомогою неї буде скинуто ваш пароль.</p>
            <input type="email" name="email" class="pole2" placeholder="Введіть свій email" required>
          </div> -->
